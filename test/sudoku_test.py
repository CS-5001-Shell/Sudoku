import unittest
from boards import *
from sudoku import read_board, check_rows, candidate_values, check_columns, check_squares, solve
...
class TestSudoku(unittest.TestCase):
    ...
    def test_read_board_file_not_found(self):
        self.assertRaises(FileNotFoundError, read_board, 'boards/DOES_NOT_EXIST.txt')

    def test_read_board_bad_format(self):
        self.assertRaises(ValueError, read_board, 'boards/invalid_board.txt')
